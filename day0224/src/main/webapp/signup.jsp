							...
							<div class="table-wrapper">
								<table class="alt">
									<tbody>
										<tr>
											<td>아이디</td>
											<td colspan="2"><input type="text" name="mid" placeholder="중복불가" required></td>
										</tr>
										<tr>
											<td>비밀번호</td>
											<td colspan="2"><input type="password" name="mpw" placeholder="비밀번호 입력" required></td>
										</tr>
										<tr>
											<td>이름</td>
											<td colspan="2"><input type="text" name="mname" placeholder="이름 입력" required></td>
										</tr>
										<tr>
											<td>계정권한</td>
											<td colspan="2">
										...
										<tr>
											...
											<a href="login.do" class="button big primary">기존 아이디로 로그인</a>
											</td>
										</tr>
									</tbody>
								</table>
