...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
         ...
         <div class="page-content">
            ...
            <div class="row" style="display: flow-root;">
               <div class="card text-center mb-5">
                  ...
                  <!--  -->
                  <div>
                     <form method="post" action="insertBoard.do" id="tag-form" onsubmit="submitForm(event)">
                     <input type="hidden" value="${member.id }" name="bId"/>
                        ...
                        <input id="title"
                           ...
                           type="text" name="bTitle" placeholder="제목을 입력해주세요." required/>
                        ...
                        <div style="display: grid;">
                           <textarea id="editor" name="bContent" placeholder="내용" rows="6" required></textarea>
                        </div>
   ...
   function submitForm(event){
	   const esul = document.getElementById("editor");
       console.log(esul.value);
       if(esul.value == ''){
    	   alert('내용을 입력해주세요!');
       } else {
    	   alert('성공');
   ...
   */
   ...
   $("#tag-form").on("submit", function (e) {
       ...
       let content = $('#editor').val();
       console.log(content.length+"sdfsdfsdf");
