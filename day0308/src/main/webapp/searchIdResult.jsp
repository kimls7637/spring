...
<body
	...
	<div id="__next" data-reactroot="">
		<div class="mt-20 flex justify-center px-6 pb-16 sm:mt-32 sm:px-0">
			<div class="w-full max-w-md" style="margin-top:150px;">
				<!-- 체크 아이콘 -->
				<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26"
					height="26" viewBox="0 0 26 26" style="display:flex; margin:auto;">
					<path
					d="M 22.566406 4.730469 L 20.773438 3.511719 C 20.277344 3.175781 19.597656 3.304688 19.265625 3.796875 L 10.476563 16.757813 L 6.4375 12.71875 C 6.015625 12.296875 5.328125 12.296875 4.90625 12.71875 L 3.371094 14.253906 C 2.949219 14.675781 2.949219 15.363281 3.371094 15.789063 L 9.582031 22 C 9.929688 22.347656 10.476563 22.613281 10.96875 22.613281 C 11.460938 22.613281 11.957031 22.304688 12.277344 21.839844 L 22.855469 6.234375 C 23.191406 5.742188 23.0625 5.066406 22.566406 4.730469 Z"></path>
					</svg>
				<p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400"
					style="margin-top: 20px; font-size:20px;">${member.mName}님의 아이디는 ${member.id}입니다.</p>
				<div class="mx-4 sm:mx-0">
					...
					<div class="relative my-7">
						...
						<div class="relative flex justify-center text-sm">
							<span class="bg-white px-2 text-gray-500 dark:bg-gray-800" style="font-size:15px;">ACENSE</span>
						</div>
					</div>

					<div
						style="border: 1px solid black; border-radius: 5px; margin-top: 40px; margin-bottom: 40px;">
						<a href="login.do" ><button type="submit"
							class="flex w-full justify-center rounded-md border border-transparent bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-400 focus:outline-none disabled:bg-blue-500 disabled:opacity-40">로그인으로
							돌아가기</button></a>
							<!-- 버튼으로 링크이동
							<button type="button" onclick="location.href='링크주소';"></button> -->
					</div>
				</div>
			</div>
		</div>
