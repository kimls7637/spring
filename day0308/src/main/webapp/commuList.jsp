               ...
               <div class="card text-center mb-5">
                  <div class="card-header p-0" style="margin-bottom: 20px;">
                     <div class="blog-media">
                        <div class="text-left">
                           <h4 style="font-weight: bold;">커뮤니티</h4>
                        ...
                        <c:if test="${member != null}">
                           <div class="  loginHere">
                              <a
                                 ...
                                 href="insertBoard.do?bCate=커뮤니티"
                  ...
                  <div class="list" style="text-align: right;">
                     <a href="recent.do?bCate=커뮤니티"><button id="recent"
                           style="color: black; text-decoration: none;">최신순</button></a> / <a
                        href="hit.do?bCate=커뮤니티"><button id="hit"
                           style="color: black; text-decoration: none;">조회순</button></a>
                  </div>
                  <hr>
                     ...
                     <tbody>
                        <c:forEach var="v" items="${commuList}" varStatus="num">
                           <tr
                              ...
                              <td>${fn:length(commuList)-num.index}</td>
                              <td><a href="commuDetail.do?bNum=${v.bNum}"
