...
public class BoardController {
	...
	public String insertInstaBoard(BoardVO vo) {
		...
		if(!uploadFile.isEmpty()) {
			...
			try {
				uploadFile.transferTo(new File("C:\\eclipse\\workspaces2\\AC\\src\\main\\webapp\\images\\"+fileName));
	...
	@RequestMapping(value = "/commuList.do", method = RequestMethod.POST)
	public String commuList(HttpServletRequest req) {
		System.out.println("board에 있는 commuList.do 입장   POST");
		return "commuList.jsp";
	}
	...
	@RequestMapping(value = "/sharingTipList.do", method = RequestMethod.POST)
	public String sharingTipList() {
		System.out.println("board에 있는 sharingTipList.do 입장   POST");
		return "sharingTipList.jsp";
	}
	...
	public String selectOneMyBoard(BoardVO vo, TagVO tvo, Model model) {
		System.out.println("BoardController에 있는 detailBoard.do 입장  GET");
		//조회수 증가
		boardService.updateBoard(vo);
