				...
				<div class="row">
					...
					<div class="card text-center mb-5" style="width: 100%;">
						<div class="card-header p-0">
							<div class="blog-media">
								...
								<!-- 커뮤니티글일때는 커뮤니티, 꿀팁공유글일때는 꿀팁공유나오게 처리  -->
									<a href="commuList.jsp" style="color: #a0ba83;"> 커뮤니티</a> / 글 상세보기
								</div>
								<hr>
						...
						<div class="upde"
							...
							<a href="insertBoard.jsp" class="up" style="margin: 0 5px 0 5px; color: black;">수정</a>/
						...
						<div class="com"
							...
							<!-- 글 제목 -->
							<!-- 글 내용 -->
								<textarea id="txt" style="width:100%; height: scrollheight; border:transparent; resize:none;" 
								disabled>냥냥냥냥냥냥냥냥</textarea>
