						...
						<form method="post" action="sign.do">
							<div class="row gtr-uniform">
								<div class="col-6 col-12-xsmall">
									<input type="text" name="mid" placeholder="id를 입력하세요."  required />
								</div>
								<div class="col-6 col-12-xsmall">
									<input type="text" name="mname" placeholder="name을 입력하세요."
										required />
								</div>
								<div class="col-6 col-12-xsmall">
									<input type="password" name="mpw" placeholder="pw를 입력하세요."
										required />
								</div>
								<div class="col-12">
									<ul class="actions">
										<li><input type="submit" value="회원가입" class="button big" /></li>
									</ul>
								</div>
							</div>
						</form>
