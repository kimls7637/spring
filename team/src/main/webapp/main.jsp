							...
							<!-- Content -->
								<section>
								    ...
								    <form action="main.do" method="post">
								    		<select name="searchCondirion">
								    				<c:forEach var="v" items="${searchMap }">
								    						<option value="${v.value}">${v.key}</option>
								    				</c:forEach>
								    		</select>
								    		<input type="text" name="searchContent" placeholder="검색어를 입력하세요" required>
								    		<input type = "submit" value="검색" class="button prima">
								    		<input type = "button" value="글작성" class="boutton prima" onclick="location.href='insertBoard.jsp'"/>
								    </form>
