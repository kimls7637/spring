					...
					<form action="updateBoard.do" method="post">
						<div class="row gtr-uniform">
							<div class="col-6 col-12-xsmall">
								<input type="hidden" name="bid" value="${board.bid}" required />
							...
							<!-- Break -->
							<div class="col-12">
								<textarea name="content" placeholder="${board.content}" rows="6"></textarea>
							</div>
							<!-- Break -->
							<div class="col-12">
								<ul class="actions">
									<li><input type="submit" value="글 수정하기" class="button big" /></li>
								</ul>
							</div>
						</div>
