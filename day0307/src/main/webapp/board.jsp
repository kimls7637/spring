					...
					<div class="content">
						...
						<c:if test="${data.writer != member.mid}">
							<form method="post" action="main.do">
								<input type="hidden" name="bid" value="${data.bid}" /> <input
									type="text" name="title" value="${data.title}" readonly /> <input
									type="text" name="writer" value="${data.writer}" readonly />
						...
						<c:if test="${data.writer == member.mid}">
							<form method="post" action="update.do">
								<input type="hidden" name="bid" value="${data.bid}" /> <input
									...
									name="writer" value="${data.writer}" placeholder="writer"
									readonly />
								<textarea id="editor">${data.content}</textarea>
								<input type="submit" value="수정하기" /> <input type="button"
									value="삭제하기"
									onclick="location.href='delete.do?bid=${data.bid}'" /> <input
									type="button" value="뒤로가기" onclick="location.href='main.do'" />
							</form>
						</c:if>
					</div>
