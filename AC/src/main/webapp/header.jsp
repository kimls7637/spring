      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link"
               href="menuBList.do?bCate=공지사항" style="font-size: 15px;"><spring:message
                     code="message.header.noticeList" /></a></li>
            <li class="nav-item"><a class="nav-link"
               href="commuList.do" style="font-size: 15px;"><spring:message
                     code="message.header.commuList" /></a></li>
            <li class="nav-item"><a class="nav-link"
               href="menuBList.do?bCate=꿀팁공유" style="font-size: 15px;"><spring:message
