				...
				<div class="row">
					...
					<div class="card text-center mb-5">
						<div class="card-header p-0">
							<div class="blog-media">
								<div class="text-left">
									<a href="forgot.jsp" style="color: #a0ba83;"> 꿀팁공유</a> / 레시피 공유
								</div>
								<hr>
						...
						<div class="upde"
							...
							<div class="up" style="margin:0 5px 0 5px;">수정</div>/
							<div class="de" style="margin:0 5px 0 5px;">삭제</div>
						</div>
						...
						<div class="com"
							...
							<!-- 닉네임
								 ...
								 글 내용  -->
							<div class="left">
								<h5 class="card-title mb-2">나는지민</h5>
							...
							<p class="my-2">Lorem ipsum dolor sit amet, consectetur
								...
								reprehenderit animi, est ratione fugit aspernatur ipsum. Nostrum
								placeat hic saepe voluptatum dicta ipsum beatae.</p>
