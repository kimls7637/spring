...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
	...
	<aside class="lg:col-span-3 lg:pr-16"
		...
		<nav class="my-4 space-y-2 lg:my-10">
			<a
				...
				aria-current="page" href="myBList.do?id=${member.id}"><svg
				...
				class="text-gray-500 group flex items-center rounded-md px-3 py-2 font-medium hover:bg-gray-200 hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-300"
				href="myCList.do?id=${member.id}"><svg xmlns="http://www.w3.org/2000/svg"
					fill="none" viewBox="0 0 24 24" stroke-width="1.5"
					stroke="currentColor" aria-hidden="true"
					class=" text-gray-400 dark:text-gray-600 -ml-1 mr-3 h-6 w-6 shrink-0 group-hover:text-gray-800 dark:group-hover:text-gray-200">
					<path stroke-linecap="round" stroke-linejoin="round"
	...
	<div>
		...
		<div class="my-10 lg:my-0 lg:pl-20">
			<h2 class="text-xl font-semibold leading-6">나의 게시글</h2>
			<!-- 게시글번호 / 제목 / 작성날짜 띄우기 -->
					...
					<div>
						...
						<div class="mt-10">
							<div class="mb-9 sm:mb-16">
								...
								<c:forEach var="v" items="${myBoardList}">
									<li class="py-5"
											...
											<div class="w-full space-y-2">
												<div class="flex items-center gap-x-2">
													<div
														...
														<div
															class="rounded-2xl border border-gray-500/30 py-1.5 px-3 text-xs font-medium text-blue-500 hover:border-gray-400 dark:border-gray-500/70 dark:hover:border-gray-400"
															style="color: #a0ba83; font-weight: bold;">${v.bCate}</div>
														<div class="text-gray-500">에 게시물을 작성하였습니다.</div>
													</div>
													<div
														class="hidden text-sm font-normal text-gray-500 sm:block">${v.bDate}</div>
												</div>
												<div class="listA">
													<a
														...
														href="detailBoard.do?bNum=${v.bNum}">${v.bTitle}</a>
												</div>
