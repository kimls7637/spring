	...
	<div id="__next" data-reactroot="">
		<div class="mt-20 flex justify-center px-6 pb-16 sm:mt-32 sm:px-0">
			<div class="w-full max-w-md">
				<!-- 사진이 안뜸 이상함 -->
				<h1 class="mt-6 text-center text-2xl font-bold sm:text-3xl">아이디 찾기</h1>

				
				<p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400" style="margin-top:20px;">회원가입시 입력하신 이메일 주소를 입력하시면,<br>
								...
								<div>
									...
									<div class="mt-1">
										<input id="email-address" type="email" autocomplete="email"
											...
											placeholder="acensecommu@sixsense.com" name="email" style="width: 80%; display: inline-block;">
												<div
