	...
	<aside class="lg:col-span-3 lg:pr-16"
		...
		<nav class="my-4 space-y-2 lg:my-10">
			<a
				...
				<a
				class="text-gray-500 group flex items-center rounded-md px-3 py-2 font-medium hover:bg-gray-200 hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-300"
				href="myPage2.jsp"><svg xmlns="http://www.w3.org/2000/svg"
					fill="none" viewBox="0 0 24 24" stroke-width="1.5"
					stroke="currentColor" aria-hidden="true"
					class=" text-gray-400 dark:text-gray-600 -ml-1 mr-3 h-6 w-6 shrink-0 group-hover:text-gray-800 dark:group-hover:text-gray-200">
					<path stroke-linecap="round" stroke-linejoin="round"
			...
			<div class="my-10 lg:my-0 lg:pl-20">
				...
				<div class="my-10 flex flex-col lg:flex-row"
					...
					<div class="flex-grow space-y-6" style="width: 65%;">
						<div class="divide-y divide-gray-500/50"><div class="my-10 lg:my-10 lg:pl-20"><div><div class="mt-3 space-y-2 rounded-md border border-gray-500/50 p-3"><p class="text-sm text-gray-500">회원 탈퇴일로부터 계정과 닉네임을 포함한 계정 정보(아이디/이메일/닉네임)는<br>개인정보 보호방침에 따라 <strong>60일간 보관(잠김)</strong>되며, 60일 경과된 후에는 모든 개인 정보는 완전히 삭제되며 더 이상 복구할 수 없게 됩니다.</p><p class="text-sm text-gray-500">작성된 게시물은 삭제되지 않으며, 익명처리 후 ACENSE 로 소유권이 귀속됩니다.</p></div></div><ul class="mt-2 divide-y divide-gray-500/50"><li class="flex flex-col justify-between gap-y-2 py-4 sm:flex-row sm:items-center"><div class="flex items-center"><input id="withdraw-agreements" name="agreements" type="checkbox" class="h-4 w-4 cursor-pointer rounded border border-gray-500/30 text-blue-500 focus:border-gray-500 focus:outline-none focus:ring-0 focus:ring-offset-0 dark:bg-gray-500/20"><label for="withdraw-agreements" class="ml-2 block text-sm">계정 삭제에 관한 정책을 읽고 이에 동의합니다.</label></div><button class="group relative w-full justify-center rounded-md border border-transparent bg-red-600 px-14 py-2 text-sm font-medium text-red-100 shadow-sm hover:bg-red-700 focus:outline-none disabled:bg-red-600 disabled:opacity-40 sm:w-48"><span class="absolute inset-y-0 left-0 flex items-center pl-3"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="h-5 w-5"><path stroke-linecap="round" stroke-linejoin="round" d="M22 10.5h-6m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z"></path></svg></span>회원탈퇴</button></li></ul></div></div>
