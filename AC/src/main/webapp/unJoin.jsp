							...
							<div>
								<div
									...
									<p class="text-sm text-gray-500">
										회원 탈퇴일로부터 계정과 닉네임을 포함한 계정 정보(아이디/이메일/닉네임)는<br>개인정보 보호방침에
										따라 <strong>60일간 보관(잠김)</strong>되며, 60일 경과된 후에는 모든 개인 정보는 완전히
										삭제되며 더 이상 복구할 수 없게 됩니다.
									</p>
									<p class="text-sm text-gray-500">작성된 게시물은 삭제되지 않으며, 익명처리 후
							...
							<ul class="mt-2 divide-y divide-gray-500/50">
								<li
									class="flex flex-col justify-between gap-y-2 py-4 sm:flex-row sm:items-center"><div
										...
										<input id="withdraw-agreements" name="agreements"
											type="checkbox"
									...
									<a href="deleteMember.do?id=${member.id}" ><button style="background-color: #a0ba83; color: white;"
