...
public class BoardDAO {
	...
	private final String SQL_DELETE_WRITER="DELETE FROM BOARD WHERE WRITER=?";
	private final String SQL_SELECT_ALL="SELECT * FROM BOARD;";
	private final String SQL_SELECT_ONE="SELECT * FROM BOARD WHERE BID=?";
	private final String SQL_SELECT_SEARCH="SELECT * FROM BOARD WHERE TITLE LIKE CONCAT('%', ?, '%')";
	...
	public boolean deleteBoard(BoardVO vo) {
		...
		if(vo.getWriter() == null) {
			...
			try { 
				pstmt = conn.prepareStatement(SQL_DELETE_WRITER);
	...
	public ArrayList<BoardVO> selectAllSearch(BoardVO vo) {
		ArrayList<BoardVO> datas = new ArrayList<BoardVO>();
		conn = JDBCUtil.connect();
		try {
