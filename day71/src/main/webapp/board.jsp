								...
								<section>
									...
									<input type="hidden" name="bid" value="${data.bid}">
														<div class="row gtr-uniform">
															...
															<!-- Break -->
															<div class="col-12">
																<textarea name="content" rows="6">${data.content}</textarea>
															</div>
															<!-- Break -->
															<div class="col-12">
																<ul class="actions">
																	<li><input type="submit" value="글 변경하기" /></li>
																	<li><a href="delete.do?bid=${data.bid}" class="button primary">글 삭제하기</a></li>
																</ul>
															</div>
														</div>
													</form>
